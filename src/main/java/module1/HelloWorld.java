...
public class HelloWorld extends PApplet {
	...
	public void setup() {
		...
		AbstractMapProvider secondProvider = new Google.GoogleTerrainProvider();
		// Set a zoom level
		int zoomLevel = 10;
		...
		map2 = new UnfoldingMap(this, 410, 50, 350, 500, secondProvider);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(52.26f, -1.18f));
